 ...
 * @author jike
 */
@WebServlet(name = "FilterSemesterServlet", urlPatterns = {"/FilterSemesterServlet"})
public class FilterSemesterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONObject jsObj = new JSONObject();
            jsObj.put("filterSemesterProject", jsArr);
